...
!(function (e, t){
	...
	function (C, e){
		...
		function w (e){
			return
				null == e ? e + '' :
				'object' == typeof e || 'function' == typeof e ? n[o.call(e)] || 'object' :
				typeof e;
		}
		var f = '3.4.1',
			k = function (e, t){
		...
		var h = (function (n){
			...
			function ge (t){
				return function (e){
					return
						'form' in e ? e.parentNode && !1 === e.disabled ? 'label' in e ? 'label' in e.parentNode ? e.parentNode
							.disabled === t :
						e.disabled === t :
			...
			(T = se.setDocument = function (e){
				...
				return (
					r !== C &&
						...
						(b.find.TAG =
							d.getElementsByTagName ? function (e, t){
								return
									'undefined' != typeof t.getElementsByTagName ? t.getElementsByTagName(e) :
						...
						(y =
								...
								t || K.test(a.contains) ? function (e, t){
									var n =
									...
									(
										1 &
											(n =
													...
													(e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) :
													1) ||
										(!d.sortDetached && t.compareDocumentPosition(e) === n) ? e === C ||
										(e.ownerDocument === m && y(m, e)) ? -1 :
			...
			(se.attr = function (e, t){
				...
				var n = b.attrHandle[t.toLowerCase()],
					r =
							...
							n && j.call(b.attrHandle, t.toLowerCase()) ? n(e, t, !E) :
							void 0;
				return
					void 0 !== r ? r :
									...
									if (
										...
										while ((a = (++s && a && a[l]) || (d = s = 0) || u.pop()))
											if (
												...
												++d &&
												(p &&
													((i = (o = a[k] || (a[k] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] = [
														S,
														d
													]),
												a === e)
		...
		k.fn.extend({
			...
			closest: function (e, t){
				...
				return this.pushStack(
						...
						1 < o.length ? k.uniqueSort(o) :
						o
				);
			},
			index: function (e){
				return
					e ? 'string' == typeof e ? i.call(k(e), this[0]) :
					i.call(
						this,
			...
			k.each(
				{
					...
					contents: function (e){
						return
							'undefined' != typeof e.contentDocument ? e.contentDocument :
							...
							return function (e){
								(r[t] = this),
									(i[t] =
											...
											1 < arguments.length ? s.call(arguments) :
											e),
									--n || o.resolveWith(r, i);
							};
						};
		...
		(k.fn.ready = function (e){
			...
			(k.ready.then = F.then),
				...
				'complete' === E.readyState || ('loading' !== E.readyState && !E.documentElement.doScroll) ? C.setTimeout(
					k.ready
				) :
		...
		(Y.uid = 1),
			(Y.prototype = {
				...
				get: function (e, t){
					return
						void 0 === t ? this.cache(e) :
						e[this.expando] && e[this.expando][V(t)];
				},
				access: function (e, t, n){
					return
						void 0 === t || (t && 'string' == typeof t && void 0 === n) ? this.get(e, t) :
						(this.set(e, t, n),
		...
		k.extend({
			...
			k.fn.extend({
				data: function (n, e){
					...
					return
						'object' == typeof n ? this.each(function (){
							J.set(this, n);
						}) :
						_(
							this,
				...
				queue: function (e, t, n){
					...
					if (e)
						return (
							...
							n &&
								(
									!r || Array.isArray(n) ? (r = Q.access(e, t, k.makeArray(n))) :
									r.push(n)),
							r || []
						);
				},
		...
		function ve (e, t){
			...
			return (
				(n =
						...
						'undefined' != typeof e.getElementsByTagName ? e.getElementsByTagName(t || '*') :
						'undefined' != typeof e.querySelectorAll ? e.querySelectorAll(t || '*') :
						[]),

					void 0 === t || (t && A(e, t)) ? k.merge(
						[
							e
						],
						n
					...
					n.handler && ((n = (o = n).handler), (i = o.selector)),
						...
						(a = v.handle) ||
							(a = v.handle = function (e){
								return
									'undefined' != typeof k && k.event.triggered !== e.type ? k.event.dispatch.apply(t, arguments) :
									void 0;
							}),
						(l = (e = (e || '').match(R) || [
							''
						...
						(d = g = (s = Ee.exec(e[l]) || [])[1]),
							...
							d &&
								...
								f.add && (f.add.call(t, c), c.handler.guid || (c.handler.guid = n.guid)),
									...
									i ? p.splice(p.delegateCount++, 0, c) :
									p.push(c),
								(k.event.global[d] = !0));
				}
			},
						...
						if (1 === l.nodeType && ('click' !== e.type || !0 !== l.disabled)) {
							for (o = [], a = {}, n = 0; n < u; n++)
								void 0 === a[(i = (r = t[n]).selector + ' ')] &&
									(a[i] =
										r.needsContext ? -1 < k(i, this).index(l) :
										k.find(i, this, null, [
											l
										]).length),
									a[i] && o.push(r);
			...
			(k.Event = function (e, t){
				if (!(this instanceof k.Event)) return new k.Event(e, t);
					...
					(this.isDefaultPrevented =
							...
							e.defaultPrevented || (void 0 === e.defaultPrevented && !1 === e.returnValue) ? ke :
							Se),
					(this.target =

							e.target && 3 === e.target.nodeType ? e.target.parentNode :
							e.target),
			...
			k.each(
				{
					...
					which: function (e){
						var t = e.button;
						return
							null == e.which && Te.test(e.type) ? null != e.charCode ? e.charCode :
							e.keyCode :
		...
		function Re (e){
			return (
					...
					'true/' === (e.type || '').slice(0, 5) ? (e.type = e.type.slice(5)) :
					...
					for (l = a[a.length - 1].ownerDocument, k.map(a, Re), c = 0; c < s; c++)
						(u = a[c]),
							he.test(u.type || '') &&
								...
								k.contains(l, u) &&
								(
									u.src && 'module' !== (u.type || '').toLowerCase() ? k._evalUrl &&
									!u.noModule &&
			...
			style: function (e, t, n, r){
				if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
					...
					if ((u || (t = Ge(s)), (a = k.cssHooks[t] || k.cssHooks[s]), void 0 === n))
						return
							a && 'get' in a && void 0 !== (i = a.get(e, !1, r)) ? i :
							l[t];
				...
				function (e, u){
					k.cssHooks[u] = {
						get: function (e, t, n){
							if (t)
								return
									!Ye.test(k.css(e, 'display')) || (e.getClientRects().length && e.getBoundingClientRect().width) ? tt(
										e,
										u,
										n
									) :
			...
			(((k.Tween = nt).prototype = {
				...
				run: function (e){
					...
					return (
							...
							this.options.duration ? (this.pos = t = k.easing[this.easing](
								e,
			...
			((nt.propHooks = {
				_default: {
					...
					set: function (e){
							...
							1 !== e.elem.nodeType || (!k.cssHooks[e.prop] && null == e.elem.style[Ge(e.prop)]) ? (e.elem[e.prop] =
								e.now) :
		...
		function lt (){
			it &&
				(
					!1 === E.hidden && C.requestAnimationFrame ? C.requestAnimationFrame(lt) :
			...
			k.each(
				...
				function (e, r){
					...
					k.fn[r] = function (e, t, n){
						return
							null == e || 'boolean' == typeof e ? i.apply(this, arguments) :
		...
		k.fn.extend({
			...
			k.extend({
				attr: function (e, t, n){
					...
					if (3 !== o && 8 !== o && 2 !== o)
						return
							'undefined' == typeof e.getAttribute ? k.prop(e, t, n) :
							((1 === o && k.isXMLDoc(e)) ||
								(i =
									k.attrHooks[t.toLowerCase()] ||
									(
										k.expr.match.bool.test(t) ? ht :
										void 0)),
		...
		k.fn.extend({
					...
					if (3 !== o && 8 !== o && 2 !== o)
						return (
							(1 === o && k.isXMLDoc(e)) || ((t = k.propFix[t] || t), (i = k.propHooks[t])),
								...
								void 0 !== n ? i && 'set' in i && void 0 !== (r = i.set(e, n, t)) ? r :
								(e[t] = n) :
								i && 'get' in i && null !== (r = i.get(e, t)) ? r :
								e[t]
						);
				...
				propHooks: {
					tabIndex: {
						get: function (e){
							...
							return
								t ? parseInt(t, 10) :
								vt.test(e.nodeName) || (yt.test(e.nodeName) && e.href) ? 0 :
								-1;
						}
					}
				},
			...
			k.fn.extend({
				...
				toggleClass: function (i, t){
					...
					return
						'boolean' == typeof t && a ? t ? this.addClass(i) :
						this.removeClass(i) :
		...
		k.extend(k.event, {
			trigger: function (e, t, n, r){
				var i,
					...
					d =
						v.call(e, 'type') ? e.type :
						e,
					h =
						v.call(e, 'namespace') ? e.namespace.split('.') :
						[];
				if (
					((o = f = a = n = n || E),
					3 !== n.nodeType &&
				...
				serializeArray: function (){
					return this.map(function (){
						...
						.map(function (e, t){
							...
							return
								null == n ? null :
								Array.isArray(n) ? k.map(n, function (e){
				...
				ajax: function (e, t){
					...
					var c,
						...
						m =
								...
								v.context && (y.nodeType || y.jquery) ? k(y) :
								k.event,
						x = k.Deferred(),
								...
								return function (){
									o &&
										((o = a = r.onload = r.onerror = r.onabort = r.ontimeout = r.onreadystatechange = null),
											...
											'abort' === e ? r.abort() :
											'error' === e ? 'number' != typeof r.status ? t(0, 'error') :
		...
		k.ajaxSetup({
			...
			k.ajaxPrefilter('json jsonp', function (e, t, n){
				...
				if (a || 'jsonp' === e.dataTypes[0])
					return (
						(r = e.jsonpCallback =
							m(e.jsonpCallback) ? e.jsonpCallback() :
							e.jsonpCallback),
			...
			(k.parseHTML = function (e, t, n){
				return
					...
					t ||
						(
							y.createHTMLDocument ? (((r = (t = E.implementation.createHTMLDocument('')).createElement('base')).href =
								E.location.href),
			...
			k.fn.extend({
				offset: function (t){
					...
					var e,
						...
						r = this[0];
					return
						r ? r.getClientRects().length ? ((e = r.getBoundingClientRect()),
					...
					k.fn[o] = function (e, t){
						...
						return _(
							...
							function (e, t, n){
								var r;
								return
									x(e) ? 0 === o.indexOf('outer') ? e['inner' + a] :
			...
			k.each(
				...
				function (e, n){
					k.fn[n] = function (e, t){
						return
							0 < arguments.length ? this.on(n, null, e, t) :
							this.trigger(n);
					};
				}
			),
